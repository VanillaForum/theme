            ...
            <div class="row tab-content personal-info" >
                ...
                <div role="tabpanel" class="tab-pane active col-xs-12 col-md-12" id="personalinfo">
                    ...
                    <div class="col-xs-12 col-md-10">
                        <form class="form-horizontal cpi_form" method="post" action="javascript:void(0)" name="cpi-form" id="upi-form-user">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 save-btn">
                                    ...
                                    <input id="send-upi-form-user" type="submit" name="cpi_btn" class="btn type-c cpi_btn" value="Save">
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane col-xs-12 col-md-12 preference-section" id ="preference">
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <form class="form-horizontal client-preference-form" id="preference-form" method="post" action="javascript:void(0)">
                            <input type="hidden" name = "user_id" value="<?php echo $user->id; ?>" />
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 text-left">
									<a href="javascript:void(0)" data-toggle="modal" data-target="#disable-account-modal" class="btn type-b">Disable My Account<img src="<?php  echo base_url() ; ?>assets/images/disable-account.png" alt="" /></a>
                                </div>
                    ...
                    <div class="col-xs-12 col-md-12 billing-info">
                        <h5 class="text-center billing-header">Billing Info</h5>
                        ...
                        <ul class="<?php echo 'cc_info_'.$cc_info->id; ?>">
                            ...
                            <li><?php if(substr($cc_info->card_no, 0,1) == 3)
									echo "AMEX";
								elseif(substr($cc_info->card_no, 0,1) == 4)
									echo "VISA";
								elseif(substr($cc_info->card_no, 0,1) == 5)
									echo "MASTERCARD"; 
								?> **** **** **** <?php echo substr($cc_info->card_no, -4)?></li>
