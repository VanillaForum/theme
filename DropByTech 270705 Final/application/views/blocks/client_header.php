<?php $message_count = $this->messages_model->get_cliente_messages_count($this->session->userdata['user_data']['id'])->result();?>
<style>
.circular1 {
	width: 32px;
	height: 32px;
...
<div class="bg-img" style="background-image: url(<?php echo base_url(); ?>assets/images/banner-1.png); background-size:cover">
    <div class="project-header">
            ...
            <ul class="nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" id="menu1">
                        <li><a href="<?php echo base_url(); ?>client/personal_info"><img src="<?php echo base_url(); ?>assets/images/profile.png" />Profile</a></li>
		...
		<div class="project-profile hidden-mobile">
            <ul class="nav">
                <li class="dropdown">
                    <a href="<?php echo base_url(); ?>client/messages" class="dropdown-toggle">
        ...
        <div class="project-button">
            <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn type-a">Post a project</a>
        ...
        <div class="project-profile visible-mobile">
            <ul class="nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" id="menu1">
                        <li><a href="#"><img src="<?php echo base_url(); ?>assets/images/profile.png" />Profile</a></li>
                        <li><a href="<?php echo base_url(); ?>home/logout"><img src="<?php echo base_url(); ?>assets/images/log-out.png" />Logout</a></li>
                    </ul>
                </li>
            </ul>
